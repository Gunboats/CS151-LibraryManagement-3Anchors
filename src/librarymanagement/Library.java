...
public class Library {
    ...
    private Map<String, User> cardNumAndUserMap = new HashMap<>();
    private Map<String, User> phoneNumAndUserMap = new HashMap<>();
    ...
    public boolean containsNumber(String number) {
        return !phoneNumAndUserMap.containsKey(number);
    }
